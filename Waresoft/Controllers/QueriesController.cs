...
namespace Waresoft.Controllers
{
    ...
    {
        private const string CONN_STR = "Server=YAKOVYSHENA\\SQLEXPRESS;Database=Waresoft;Trusted_Connection=True;MultipleActiveResultSets=true";
        
        private const string S1_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\S1.sql";
        private const string S2_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\S2.sql";
        private const string S3_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\S3.sql";
        private const string S4_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\S4.sql";
        private const string S5_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\S5.sql";
        private const string S6_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\S6.sql";

        private const string A1_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\A1.sql";
        private const string A2_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\A2.sql";
        private const string A3_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\A3.sql";

        private const string T1_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\T1.sql";
        private const string T2_PATH = @"C:\Users\test\Desktop\дзшки\інфа\Waresoft\Queries\T2.sql";
